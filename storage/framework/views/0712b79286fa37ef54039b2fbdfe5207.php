            ...
            <div class="card-body">
                <form action="<?php echo e(route('items.update', $item)); ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="buy_price" name="buy_price" step="0.01" min="0" value="<?php echo e($item->buy_price); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="sell_price" class="form-label">Harga Jual</label>
                        <input type="number" class="form-control" id="sell_price" name="sell_price" step="0.01" min="0" value="<?php echo e($item->sell_price); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="stock" class="form-label">Stok</label>
                        <input type="number" class="form-control" id="stock" name="stock" min="0" value="<?php echo e($item->stock); ?>" required>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bengkel\resources\views/items/edit.blade.php ENDPATH**/ ?>