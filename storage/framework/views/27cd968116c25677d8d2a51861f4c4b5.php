...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('capitals.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <a href="<?php echo e(route('capitals.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bengkel\resources\views/capitals/create.blade.php ENDPATH**/ ?>